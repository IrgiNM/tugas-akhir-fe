...
const DiagramProtocol = () => {
  const {dataProtokol, dataCount, dataTenY, dataNerworkTraffic} = dataNetworkTrafficFunction()
  ...
  return (
    <div className='w-full flex flex-col border-1 border-white rounded-md p-5'>
        <p className='text-[20px] font-bold'>Protokol</p>
        <p className='mb-7'>Statistik banyak nya protokol yang ada</p>
...
export default DiagramProtocol