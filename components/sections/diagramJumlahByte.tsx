...
const DiagramJumlahByte = () => {
  const {dataJumlahByte, dataCount, dataTenY, dataNerworkTraffic} = dataNetworkTrafficFunction()
  ...
  return (
    <div className='w-full flex flex-col border-1 border-white rounded-md p-5'>
        <p className='text-[20px] font-bold'>Jumlah Bytes</p>
        <p className='mb-7'>Statistik banyak nya Jumlah Bytes yang ada ( satuan byte )</p>
...
export default DiagramJumlahByte